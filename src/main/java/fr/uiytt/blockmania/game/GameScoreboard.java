...
public class GameScoreboard {
	...
	public void createScoreboard(Player player) {
		...
		//Title
		Objective obj = scoreboard.registerNewObjective("title","dummy",ChatColor.YELLOW + "" + ChatColor.BOLD + "❂ BlockShuffle ❂");
	...
	public static void updateTabScore(Player player, int score) {
		playersScoreboard.forEach((uuid, gameScoreboard) -> {
			gameScoreboard.getScoreboard().getObjective("BSHUF_tabscore").getScore(player.getName()).setScore(score);
		});
	}
